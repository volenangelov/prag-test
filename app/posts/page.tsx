    ...
    <>
      ...
      <div className="pt-16 md:pt-28 pb-16 md:pb-24 bg-dark mt-[75px] border-b-2 border-pink  dark:border-gray-600">
        <Container className="max-w-6xl">
          <div>
            <p className="text-2xl md:text-4xl text-center mb-6 text-white">Blog</p>
            <p className="text-center text-white">Thoughts, opinions and helpful guides covering all things digital.</p>
          </div>
        </Container>
      </div>
      <Container>
